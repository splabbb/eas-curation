"""
EAS Vision Analysis Module - Image scoring using Open-CLIP
"""
...
class VisionAnalyzer:
    """Analyzes images using Open-CLIP model."""

    def __init__(self, model_name: str = "ViT-B-32", device: str = "auto", threshold: float = 0.45):
        """Initialize the Vision Analyzer."""
        self.model_name = model_name
        self.threshold = threshold
        self.device = "cuda" if (device == "auto" and torch.cuda.is_available()) else "cpu"

        logger.info(f"Initializing VisionAnalyzer with {model_name} on {self.device}")
